...
@Composable
fun TaskAddScreen(viewModel: TaskViewModel,navController:NavHostController,innerpadding:PaddingValues){
    ...
    var taskStartDate by remember { mutableStateOf(date.format(formatter)) }
    var taskEndDate by remember { mutableStateOf(date.format(formatter)) }
